<x-layout>
    ...
    <div class="relative overflow-x-auto shadow-md rounded-lg border border-gray-300 py-2 px-2 bg-white">
        ...
        {{-- FORM DESKTOP --}}
        <form class="mx-auto" action="{{ route('customer.store') }}" method="POST"> @csrf
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="mb-2">
                    <label for="CardCode" class="mb-2 text-sm font-medium text-gray-700">Kode Pelanggan</label>
                    <input type="text" id="CardCode" name="CardCode" value="{{ old('CardCode') }}" autocomplete="off"
                ...
                <div class="mb-2">
                    ...
                    <input type="text" id="CardName" name="CardName" value="{{ old('CardName') }}" autocomplete="off"
                        class="bg-gray-100 border border-gray-300 text-gray-800 placeholder-gray-500 focus:ring-indigo-600 focus:border-indigo-600 text-sm rounded-lg w-full p-2.5"
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="mb-2">
                    ...
                    <input type="text" id="Contact" name="Contact" value="{{ old('Contact') }}" autocomplete="off"
                        class="bg-gray-100 border border-gray-300 text-gray-800 placeholder-gray-500 focus:ring-indigo-600 focus:border-indigo-600 text-sm rounded-lg w-full p-2.5"
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="mb-2">
                    ...
                    <input type="number" id="NIK" name="NIK" value="{{ old('NIK') }}" autocomplete="off"
                        class="bg-gray-100 border border-gray-300 text-gray-800 placeholder-gray-500 focus:ring-indigo-600 focus:border-indigo-600 text-sm rounded-lg w-full p-2.5"
                        placeholder="NIK" />
                    @error('NIK')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
            ...
            <input type="number" value="{{ auth()->user()->id }}" id="created_by" name="created_by" class="hidden">
            <button type="submit"
