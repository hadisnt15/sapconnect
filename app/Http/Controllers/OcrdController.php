...
class OcrdController extends Controller
{
    ...
    {   
        ...
        $custs = OcrdLocal::query()->withExists('ocrd_card')->Filter(request(['search']))->whereIn('div_name',$userDiv)->orderByDesc('ocrd_card_exists')->orderBy('Group')->orderBy('CardName')->paginate(100)->withQueryString();
