    ...
    <div class="relative overflow-x-auto shadow-md rounded-lg border border-gray-200 py-2 px-2 bg-white">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-3">
            ...
            <div class="flex flex-col sm:flex-col md:flex-row md:items-center md:justify-end gap-3 w-full md:w-auto">
                ...
                <!-- 🔴 Sinkronisasi SAP -->
                <form method="POST" action="<?php echo e(route('report.refresh.pencapaian-penjualan-retail-per-sales')); ?>" 
        ...
        <div class="p-2 border border-gray-200 mt-4 rounded-lg bg-white">
            <div><h5 class="text-gray-800 font-bold ms-4 mb-2">Pencapaian Penjualan Retail per Penjual periode <?php echo e($namaPeriode); ?> dalam Bentuk Liter</h5></div>
            <div class="grid md:grid-cols-2 gap-3">
                <?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salesName => $salesData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="relative overflow-x-auto max-h-[600px] shadow-sm sm:rounded-lg">
                            <table class="table-auto w-full text-sm text-left rtl:text-right text-gray-600">
                                ...
                                <tbody>
                                        ...
                                        <?php $__currentLoopData = $salesData['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="hover:bg-gray-50 border-t">
                                                <td class="px-2 py-2 font-medium text-gray-700"><?php echo e($row->SEGMENT); ?></td>
                                                <td class="px-2 py-2 text-right font-medium text-gray-700"><?php echo e(number_format($row->TARGET ?? 0, 2, '.', ',')); ?></td>
                                                <td class="px-2 py-2 text-right font-medium text-gray-700"><?php echo e(number_format($row->LITER ?? 0, 2, '.', ',')); ?></td>
                                                <td class="px-2 py-2 text-right font-medium text-gray-700"><?php echo e($row->PERSEN); ?>%</td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    
                                    <tr class="bg-indigo-50 font-bold text-red-900">
                                        <td class="px-2 py-2 border-t">TOTAL <?php echo e($salesName); ?></td>
                                        <td class="px-2 py-2 text-right border-t"><?php echo e(number_format($salesData['sum_target'] ?? 0, 2, '.', ',')); ?></td>
                                        <td class="px-2 py-2 text-right border-t"><?php echo e(number_format($salesData['sum_liter'] ?? 0, 2, '.', ',')); ?></td>
                                        <td class="px-2 py-2 text-right border-t"><?php echo e(number_format($salesData['sum_persen'] ?? 0, 2, '.', ',')); ?>%</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sapconnect\resources\views/reports/penjualan_rtl_sales.blade.php ENDPATH**/ ?>