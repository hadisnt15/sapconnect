...
<?php $component->withAttributes([]); ?>
    ...
    <div class="relative overflow-x-auto shadow-md rounded-lg border border-gray-200 py-2 px-2 bg-white">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-3">
            <!-- 🔍 Form Pencarian (Kiri) -->
            <form action="<?php echo e(route('report.bulanan-dan-average-liter')); ?>" method="get" class="flex items-center gap-2 w-full md:w-auto">
                <div>
            ...
            <div class="flex flex-col sm:flex-col md:flex-row md:items-center md:justify-end gap-3 w-full md:w-auto">
                ...
                <!-- 🔴 Sinkronisasi SAP -->
                <form method="POST" action="<?php echo e(route('report.refresh.bulanan-dan-average-liter')); ?>" 
        ...
        <div class="hidden md:block p-2 border border-gray-200 mt-4 rounded-lg bg-white">
            <div><h5 class="text-gray-800 font-bold ms-4 mb-2">Laporan Pencapaian Pelanggan Periode <?php echo e($namaPeriode); ?> dan Rata-rata 3 Bulan Terakhir Dalam Bentuk Liter</h5></div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sapconnect\resources\views/reports/bulanan_dan_average_liter.blade.php ENDPATH**/ ?>