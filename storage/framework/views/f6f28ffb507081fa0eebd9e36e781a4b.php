    ...
    <div class="relative overflow-x-auto shadow-md rounded-lg border border-gray-200 py-2 px-2 bg-white">
        ...
        <form class="mx-auto" action="<?php echo e(route('order.update', $head->id)); ?>" method="post">
            ...
            <div>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="mb-2">
                        ...
                        <input type="text" name="OdrCrdCode" id="OdrCrdCode"
                            value="<?php echo e(old('OdrCrdCode', $head['OdrCrdCode'])); ?>"
                            readonly
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="mb-2">
                        ...
                        <input type="text" name="OdrRefNum" readonly
                            value="<?php echo e($head['OdrRefNum']); ?>"
                            class="bg-gray-50 border border-gray-300 text-gray-700 rounded-lg w-full p-2.5 text-sm">
                    </div>
                ...
                <div x-data="{
                    items: <?php echo \Illuminate\Support\Js::from($rows)->toHtml() ?>.map(i => ({
                        ...i,
                        isNew: false,
