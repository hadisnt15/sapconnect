                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <span class="ms-1 text-sm font-medium text-red-800 md:ms-2">
                            <i class="ri-account-circle-2-fill"></i> <?php echo e($titleHeader); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-4 items-center pb-4 w-full">
            ...
            <div class="md:ml-auto">
                <div class="flex items-center">
                    ...
                    <div>
                        <a href="<?php echo e(route('customer.refresh')); ?>"
                            class="text-xs rounded-lg px-3 py-2 bg-red-800 hover:bg-red-500 font-medium text-white">
...
</script><?php /**PATH C:\laragon\www\sapconnect\resources\views/ocrd/ocrd.blade.php ENDPATH**/ ?>