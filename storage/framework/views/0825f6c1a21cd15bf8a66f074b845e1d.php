...
<?php $component->withAttributes([]); ?>
    ...
    <div class="relative overflow-x-auto shadow-md rounded-lg border border-gray-200 py-4 px-6 bg-white">
        ...
        <div class="mx-auto w-full md:w-1/2 bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
            <h2 class="text-sm font-medium text-gray-700 mb-3">Kelola Divisi untuk <?php echo e($user->name); ?></h2>
            <!-- Form -->
            <form action="<?php echo e(route('user.updateDivision', $user->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-4">
                    ...
                    <?php $__currentLoopData = $divisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $division): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center mb-2">
                            <input type="checkbox" name="divisions[]" value="<?php echo e($division->id); ?>"
                                <?php echo e($user->divisions->contains($division->id) ? 'checked' : ''); ?>

                                class="w-4 h-4 text-red-800 rounded border-gray-300 focus:ring-red-500">
                            <label class="ml-2 text-sm text-gray-700"><?php echo e($division->div_name); ?> - <?php echo e($division->div_desc); ?></label>
                        </div>
...
</script><?php /**PATH C:\laragon\www\sapconnect\resources\views/user/user_division.blade.php ENDPATH**/ ?>